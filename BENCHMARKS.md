...
| 6 | `fastcrc` | C# (.NET 8 console, xUnit + coverlet) | CRC-32 (IEEE 802.3) single-command checksum CLI (micro tier, ~10-min serial build) | — (CLI/UX) | 60–120 (120 advised) | ≥ 85% (Fastcrc assembly) | [specs/06-csharp-fastcrc/SPEC.md](specs/06-csharp-fastcrc/SPEC.md) | ⬜ not run |
