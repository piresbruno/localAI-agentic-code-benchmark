...
| 2026-09-02 | huffcode | deepseek-v4-flash-vision-exp/pi | pending grading | 87.25% lines (Huffcode assembly, coverlet) | — | — | 00:53:00 | 3 | 19 tests green; LOC 625 (above 350 advisory — Format has strict validation, full feature set kept — see README/PLAN); parallel slices run concurrently (3 subagents) |
| 2026-09-02 | fastcrc | deepseek-v4-flash-vision-exp/pi | pending grading | 96.42% lines (src/, v8) | — | — | 00:05:30 | 1 | 12 tests green; LOC 68 (within 60–120 micro-tier); serial build — under the ~10-min target; pins cross-checked against python zlib.crc32 |
