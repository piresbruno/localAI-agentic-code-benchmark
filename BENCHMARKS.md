...
| 5 | `huffcode` | C# (.NET 8 console, xUnit + coverlet) | Lossless Huffman codec CLI (sprint tier, contract-first parallel slices — parallelization scored) | — (CLI/UX) | 200–350 (350 advised) | ≥ 85% (Huffcode assembly) | [specs/05-typescript-huffcode/SPEC.md](specs/05-typescript-huffcode/SPEC.md) | ⬜ not run |
